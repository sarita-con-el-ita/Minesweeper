...
* **Como primer paso:** Abre la carpeta completa del proyecto en tu editor de código (como Visual Studio Code). Luego haz doble click para ver el archivo principal *InicioJuego.java*.  
